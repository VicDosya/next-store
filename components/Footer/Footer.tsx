      ...
      <div className="grid md:grid-cols-4 md:gap-8 grid-cols-2">
        <div className="mt-12 md:mt-0">
          ...
          <ul role="list" className="mt-4 space-y-4">
            ...
            <li>
              <Link href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Documentation </Link>
            </li>
            <li>
              <Link href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> Guides </Link>
            </li>
            <li>
              <Link href="#" className="text-sm font-normal text-gray-500 hover:text-gray-900"> API Status </Link>
            </li>
          </ul>
        </div>
        <div className="mt-12 md:mt-0">
