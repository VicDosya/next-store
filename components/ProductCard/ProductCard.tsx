...
function ProductCard({ item }: any) {
  ...
  return (
    <>
      <div className='cursor-pointer flex flex-col justify-center my-5 mx-24 md:mx-24'>
        ...
        <div className='flex flex-col justify-center mt-2 sm:inline md:text-left sm:mx-2'>
