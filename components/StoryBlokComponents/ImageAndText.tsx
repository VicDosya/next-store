    ...
    <div className="flex justify-center items-center" {...storyblokEditable(blok)} key={blok.uid}>
      ...
      <div className="absolute">
        ...
        <div className="flex flex-col items-center">
          <div className="font-serif text-fuchsia-900 mb-3 text-2xl md:text-4xl">
          ...
          <div className="flex justify-center text-center mt-2 text-fuchsia-900 leading-none text-lg md:text-xl">
          ...
          <p className="mb-6 font-bold flex justify-center text-center mt-2 text-fuchsia-900 animate-fade animate-once animate-ease-in-out animate-delay-[1500ms] text-lg md:text-xl">for you and your family, ready in minutes.</p>
